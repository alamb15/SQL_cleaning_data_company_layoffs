...
#1. First we dont want to alter the raw data so I will create 
# a staging table where I can safely delete and update cleaning changes.
#2. I will go through my staging table and remove duplicates
#3. I will standardize my data, remove extra space, trim up anything needed
# and fix any incorrect data types.
#4. Finally I will remove null and blank values where needed 
...
#Looking at our laid_off values its difficult to determine if we could find this information
#online to determine the total number of employees laid off when this data was created.
#However, data where we cannot determine the total laid off or the percentage laid off is
#pretty useless to us and we should safely remove them from this set so we can begin querying.
...
#Our company layoffs dataset has now been cleaned and is ready for querying.
